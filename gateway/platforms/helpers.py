...
def _render_table_block(table_block: list[str]) -> str:
    ...
    for index, row in enumerate(table_block[2:], start=1):
        ...
        # A cell may already carry Markdown bold markers.  Normalize before
        # comparing/wrapping so shared consumers never emit ****heading**** or
