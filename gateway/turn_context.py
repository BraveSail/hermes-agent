...
class TurnContext:
    ...
    # Local fork §2: Telegram DM-only live-surface gate; False suppresses every live surface
    # (streaming deltas, interim, tool/thinking progress, reasoning) for this turn.
    _live_surfaces_allowed: bool = True
